...
│
├── plots/
│   ├── plot1_team_players.png
│   ├── plot2_position_distribution.png
│   ├── plot3_age_distribution.png
│   ├── plot4_height_vs_weight.png
│   ├── plot5_salary_by_position.png
│   ├── plot6_age_by_position.png
│   ├── plot7_college_team.png
│   ├── plot8_team_position_player.png
│   ├── plot9_height_weight_position.png
│   ├── plot10_age_height_weight.png
│   └── team_chart.png
````
